...
const STATUS_PRIORITY: Record<string, number> = {
  PENDING: 0, SENT_TO_MOOVEX: 1, RECEIVED: 2,
  IN_TRANSIT: 3, DELIVERED: 4, INCIDENT: 5, CANCELLED: 6,
}
...
export async function POST(req: NextRequest) {
  ...
  const procesarWebhook = async () => {
    ...
    // ── Buscar pedido por orderNumber, externalId o qrCode ──
    ...
    // ── Notificar webhooks a terceros (Senby, Fire Master, etc.) ──
    try {
